...
public class BackgroundOld {
    ...
    public BackgroundOld() {
    }

    public BackgroundOld(String projectName, Integer backgroundNo) {
        this.projectName = projectName;
        this.backgroundNo = backgroundNo;
    }

    public BackgroundOld(Integer backgroundId, String projectName, Integer backgroundNo, Long totalRequirement, Integer limitWorker, String notice) {
