...
import com.heren.i0.jpa.DatabaseConfiguration;
...
public class LauncherStart {
    public static void main(String[] args) throws Exception {
        ...
        //DatabaseConfiguration jpaConfig = module.configuration().getDatabase();
//        migrateDatabase(jpaConfig);
        ServletContainer server = Launcher.launch(module, true);
//        if (!jpaConfig.getMigration().isPresent() || jpaConfig.getMigration().get().isAuto()){
//            prepareDataByFactories(server);
//        }
        server.start(true);
    }
